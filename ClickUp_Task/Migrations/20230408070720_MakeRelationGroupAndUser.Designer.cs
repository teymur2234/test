...
namespace ClickUp_Task.Migrations
{
    ...
    [Migration("20230408070720_MakeRelationGroupAndUser")]
    partial class MakeRelationGroupAndUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupUser", b =>
                {
                    b.HasOne("ClickUp_Task.Entity.Group", null)
                        .WithMany()
                        .HasForeignKey("GroupsGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClickUp_Task.Entity.User", null)
                        .WithMany()
